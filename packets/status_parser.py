...
def create_status_check_packet(target_uid, key, iv):
    try:
        ...
        # 🚀 FIX: বেজোড় সংখ্যা এড়াতে প্যাডিং জিরো (0) এর সংখ্যা ঠিক করা হলো (IND এর জন্য 0F14 ব্যবহার করা হয়েছে)
        if len(header_lenth_final) == 2: 
            final_packet = "0F14000000" + header_lenth_final + encrypted_packet_hex  # এখানে ৬টি শূন্য (0) হবে
        elif len(header_lenth_final) == 3: 
            final_packet = "0F1400000" + header_lenth_final + encrypted_packet_hex   # এখানে ৫টি শূন্য (0) হবে
        elif len(header_lenth_final) == 4: 
            final_packet = "0F140000" + header_lenth_final + encrypted_packet_hex    # এখানে ৪টি শূন্য (0) হবে
        else: 
            final_packet = "0F14000" + header_lenth_final + encrypted_packet_hex     # এখানে ৩টি শূন্য (0) হবে
